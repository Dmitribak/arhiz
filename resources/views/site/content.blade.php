...
<section class="section--padding-bottom-small">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="post">
                    <div class="image"><a href="text.html"><img src="{{ asset('assets/img/blog4.jpg') }}" alt="" class="img-responsive"></a></div>
            ...
            <div class="col-sm-6">
                <div class="post">
                    <div class="image"><a href="text.html"><img src="{{ asset('assets/img/blog5.jpg') }}" alt="" class="img-responsive"></a></div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="post">
                    <div class="image"><a href="text.html"><img src="{{ asset('assets/img/blog1.jpg') }}" alt="" class="img-responsive"></a></div>
                    <h3><a href="text.html">Rit eget tincidunt condimentum</a></h3>
                    <p class="post__intro">ellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
                    <p class="read-more"><a href="text.html" class="btn btn-ghost">Continue reading     </a></p>
                </div>
            ...
            <div class="col-sm-4">
                <div class="post">
                    <div class="image"><a href="text.html"><img src="{{ asset('assets/img/blog2.jpg') }}" alt="" class="img-responsive"></a></div>
                    <h3><a href="text.html">Tempor sit amet</a></h3>
                    <p class="post__intro"> Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra. Vestibulum erat wisi, condimentum sed, commodo vitae, ornare sit amet, wisi.</p>
                    <p class="read-more"><a href="text.html" class="btn btn-ghost">Continue reading     </a></p>
                </div>
            ...
            <div class="col-sm-4">
                <div class="post">
                    <div class="image"><a href="text.html"><img src="{{ asset('assets/img/blog3.jpg') }}" alt="" class="img-responsive"></a></div>
    ...
    <div class="container-fluid">
        <div class="row no-space">
            <div class="col-lg-3 col-sm-4 col-xs-6">
                <div class="box"><a href="{{ asset('assets/img/portfolio-1.jpg') }}" title="" data-lightbox="portfolio" data-title="Portfolio image 1"><img src="{{ asset('assets/img/portfolio-1.jpg') }}" alt="" class="img-responsive"></a></div>
            </div>
            <div class="col-lg-3 col-sm-4 col-xs-6">
                <div class="box"><a href="{{ asset('assets/img/portfolio-2.jpg') }}" title="" data-lightbox="portfolio" data-title="Portfolio image 2"><img src="{{ asset('assets/img/portfolio-2.jpg') }}" alt="" class="img-responsive"></a></div>
            </div>
            <div class="col-lg-3 col-sm-4 col-xs-6">
                <div class="box"><a href="{{ asset('assets/img/portfolio-3.jpg') }}" title="" data-lightbox="portfolio" data-title="Portfolio image 3"><img src="{{ asset('assets/img/portfolio-3.jpg') }}" alt="" class="img-responsive"></a></div>
            </div>
            <div class="col-lg-3 col-sm-4 col-xs-6">
                <div class="box"><a href="{{ asset('assets/img/portfolio-4.jpg') }}" title="" data-lightbox="portfolio" data-title="Portfolio image 4"><img src="{{ asset('assets/img/portfolio-4.jpg') }}" alt="" class="img-responsive"></a></div>
            </div>
            <div class="col-lg-3 col-sm-4 col-xs-6">
                <div class="box"><a href="{{ asset('assets/img/portfolio-5.jpg') }}" title="" data-lightbox="portfolio" data-title="Portfolio image 5"><img src="{{ asset('assets/img/portfolio-5.jpg') }}" alt="" class="img-responsive"></a></div>
            </div>
            <div class="col-lg-3 col-sm-4 col-xs-6">
                <div class="box"><a href="{{ asset('assets/img/portfolio-6.jpg') }}" title="" data-lightbox="portfolio" data-title="Portfolio image 6"><img src="{{ asset('assets/img/portfolio-6.jpg') }}" alt="" class="img-responsive"></a></div>
            </div>
            <div class="col-lg-3 col-sm-4 col-xs-6">
                <div class="box"><a href="{{ asset('assets/img/portfolio-7.jpg') }}" title="" data-lightbox="portfolio" data-title="Portfolio image 7"><img src="{{ asset('assets/img/portfolio-7.jpg') }}" alt="" class="img-responsive"></a></div>
            </div>
            <div class="col-lg-3 col-sm-4 col-xs-6">
                <div class="box"><a href="{{ asset('assets/img/portfolio-8.jpg') }}" title="" data-lightbox="portfolio" data-title="Portfolio image 8"><img src="{{ asset('assets/img/portfolio-8.jpg') }}" alt="" class="img-responsive"></a></div>
            </div>
        </div>
    </div>
</section>