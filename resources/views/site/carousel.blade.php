<div id="carousel-home" data-ride="carousel" class="carousel slide carousel-fullscreen carousel-fade">
    ...
    <div role="listbox" class="carousel-inner">
        <div style="background-image: url('{{ asset('assets/img/carousel3.jpg') }}');" class="item active">
        ...
        <div style="background-image: url('{{ asset('assets/img/carousel2.jpg') }}');" class="item">
            <div class="overlay"></div>
            <div class="carousel-caption">
        ...
        <div style="background-image: url('{{ asset('assets/img/carousel1.jpg') }}');" class="item">
            <div class="overlay"></div>
            <div class="carousel-caption">
